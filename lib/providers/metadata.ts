...
export const DEFAULT_PROVIDER_METADATA: ProviderMetadata[] = [
  ...
  { id: "dkim", name: "DKIM Provider", version: "1.0.0", category: "email_authentication" },
  { id: "robots-txt", name: "robots.txt Provider", version: "1.0.0", category: "compliance" },
  { id: "security-txt", name: "security.txt Provider", version: "1.0.0", category: "compliance" },
