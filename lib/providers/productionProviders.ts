...
function isHtml(contentType = "", body = "") { return /(?:text\/html|application\/xhtml\+xml)/i.test(contentType) || /<\s*(?:!doctype\s+html|html|head|body|title|meta|script)\b/i.test(body.slice(0, 4096)); }
