...
export const userPageCopy = {
  ...
  he: {
    security: { eyebrow: "אבטחה וטיפול בנתונים", title: "כיצד ShadowScore מטפלת בנתוני חקירה", description: "ShadowScore משתמשת במידע עסקי מוגבל ובראיות שנמסרו כדי להכין הערכות סיכון מבוססות מקורות.", sections: [{ title: "מה אנחנו אוספים", items: ["שמות עסקים, דומיינים ומזהים", "ראיות והקשר שנמסרו לחקירה", "רשומות ציבוריות ואותות תפעוליים גלויים"] }, { title: "מה אנחנו לעולם לא אוספים", items: ["סיסמאות לחשבונות זירות מסחר או תשלום", "מספרי כרטיסים, קודי CVV או פרטי כניסה לבנק", "פרטי כניסה למערכות עסקיות של צד שלישי"] }, { title: "כיצד משתמשים בנתונים", items: ["זיהוי העסק הנבדק", "ארגון ראיות והפקת הדוח המבוקש", "שמירת היסטוריית דוחות וחקירות בסביבת העבודה"] }, { title: "עקרונות אבטחה", items: ["איסוף המידע הנדרש בלבד", "שמירת ההקשר והמקורות של הראיות", "הגבלת הגישה לרשומות פרטיות בסביבת העבודה", "הפרדה בין עובדות שנצפו, ניתוח ורמת ודאות"] }] },
