...
export const userPageCopy = {
  en: {
    security: { eyebrow: "Security and data handling", title: "Evidence-based risk review", description: "ShadowScore uses evidence uploads, visible operational signals, and seller-supplied context to prepare an assessment.", items: ["Marketplace passwords are not required", "Do not upload card numbers or passwords", "Evidence-based document review", "Private assessment workflow", "PayPal, Payoneer, card, and bank transfer support", "Enterprise readiness and domain reputation roadmap"] },
  ...
  he: {
    security: { eyebrow: "אבטחה וטיפול בנתונים", title: "סקירת סיכונים מבוססת ראיות", description: "ShadowScore משתמשת בהעלאות ראיות, אותות תפעוליים גלויים והקשר שסופק על ידי המוכר כדי להכין הערכה.", items: ["אין צורך בסיסמאות לזירות מסחר", "אין להעלות מספרי כרטיס או סיסמאות", "סקירת מסמכים מבוססת ראיות", "תהליך הערכה פרטי", "תמיכה ב-PayPal, Payoneer, כרטיס והעברה בנקאית", "מפת דרכים למוכנות ארגונית ולמוניטין דומיין"] },
