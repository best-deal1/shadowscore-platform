...
const translations: Record<Exclude<Locale, "en">, Dictionary> = {
  ...
  ar: {
    ...
    intakeUi: {
      ...
      investigationEyebrow: "تحقيق تجاري", investigationTitle: "هل يمكنك الوثوق بهذا النشاط التجاري؟", investigationPrice: "ينتج كل تحقيق تجاري تقريرًا تنفيذيًا واحدًا بسعر 9.90 دولار لمرة واحدة.", investigationTime: "نحو 3 دقائق للبدء", investigationStepIdentify: "تحديد النشاط التجاري", investigationStepReview: "مراجعة التحقيق", investigationStepReport: "استلام التقرير التنفيذي", investigationStartTerms: "يلزم اسم النشاط التجاري أو عنوان URL للتحقيق في الهوية الصحيحة. تقديم الأدلة اختياري. البدء مجاني. يتم الدفع بعد المراجعة. لا يلزم اشتراك.", investigationTypeTitle: "اختر نوع التحقيق", selectedInvestigationType: "نوع التحقيق المحدد", investigationTypeDescription: "اختر نوع التحقيق الذي يناسب قرارك التجاري.", investigationTypeReportDescription: "كل خيار هو تحقيق تجاري واحد مدعوم بالأدلة وينتج تقريرًا تنفيذيًا واحدًا.", selectedInvestigation: "التحقيق المحدد",
  ...
  es: {
    ...
    intakeUi: {
      ...
      investigationEyebrow: "Investigación empresarial", investigationTitle: "¿Puede confiar en esta empresa?", investigationPrice: "Una investigación empresarial produce un informe ejecutivo por un precio único de 9,90 dólares.", investigationTime: "Unos 3 minutos para empezar", investigationStepIdentify: "Identificar la empresa", investigationStepReview: "Revisar la investigación", investigationStepReport: "Recibir el informe ejecutivo", investigationStartTerms: "Se requiere un nombre de empresa o una URL para investigar la identidad correcta. La evidencia es opcional. Empezar es gratis. El pago se realiza después de la revisión. No se requiere suscripción.", investigationTypeTitle: "Seleccione un tipo de investigación", selectedInvestigationType: "Tipo de investigación seleccionado", investigationTypeDescription: "Elija el tipo de investigación que corresponda a su decisión empresarial.", investigationTypeReportDescription: "Cada opción es una investigación empresarial respaldada por evidencia y produce un informe ejecutivo.", selectedInvestigation: "Investigación seleccionada",
  ...
  fr: {
    ...
    intakeUi: {
      ...
      investigationEyebrow: "Enquête commerciale", investigationTitle: "Pouvez-vous faire confiance à cette entreprise ?", investigationPrice: "Une enquête commerciale produit un rapport exécutif au prix unique de 9,90 dollars.", investigationTime: "Environ 3 minutes pour commencer", investigationStepIdentify: "Identifier l’entreprise", investigationStepReview: "Examiner l’enquête", investigationStepReport: "Recevoir le rapport exécutif", investigationStartTerms: "Le nom ou l’URL de l’entreprise est requis pour examiner la bonne identité. Les preuves sont facultatives. Le démarrage est gratuit. Le paiement intervient après l’examen. Aucun abonnement n’est requis.", investigationTypeTitle: "Sélectionnez un type d’enquête", selectedInvestigationType: "Type d’enquête sélectionné", investigationTypeDescription: "Choisissez le type d’enquête qui correspond à votre décision commerciale.", investigationTypeReportDescription: "Chaque option correspond à une enquête commerciale étayée par des preuves et produit un rapport exécutif.", selectedInvestigation: "Enquête sélectionnée",
  ...
  de: {
    ...
    intakeUi: {
      ...
      investigationEyebrow: "Geschäftliche Untersuchung", investigationTitle: "Können Sie diesem Unternehmen vertrauen?", investigationPrice: "Eine geschäftliche Untersuchung erstellt einen Executive Report zum einmaligen Preis von 9,90 US-Dollar.", investigationTime: "Etwa 3 Minuten bis zum Start", investigationStepIdentify: "Unternehmen identifizieren", investigationStepReview: "Untersuchung prüfen", investigationStepReport: "Executive Report erhalten", investigationStartTerms: "Ein Unternehmensname oder eine URL ist erforderlich, damit wir die richtige Identität untersuchen. Belege sind optional. Der Einstieg ist kostenlos. Die Zahlung erfolgt nach der Prüfung. Es ist kein Abonnement erforderlich.", investigationTypeTitle: "Untersuchungsart auswählen", selectedInvestigationType: "Ausgewählte Untersuchungsart", investigationTypeDescription: "Wählen Sie die Untersuchungsart, die zu Ihrer Geschäftsentscheidung passt.", investigationTypeReportDescription: "Jede Option ist eine beleggestützte geschäftliche Untersuchung und erstellt einen Executive Report.", selectedInvestigation: "Ausgewählte Untersuchung",
...
export const userPageCopy = {
  en: {
    security: { eyebrow: "Security and data handling", title: "How ShadowScore handles investigation data", description: "ShadowScore uses limited business information and submitted evidence to prepare source-backed risk assessments.", sections: [{ title: "What we collect", items: ["Business names, domains, and identifiers", "Evidence and context submitted for an investigation", "Public records and visible operational signals"] }, { title: "What we never collect", items: ["Marketplace or payment account passwords", "Card numbers, CVV codes, or banking credentials", "Credentials for third-party business systems"] }, { title: "How your data is used", items: ["Resolve the business identity under review", "Organize evidence and produce the requested report", "Maintain report and investigation history in your workspace"] }, { title: "Security principles", items: ["Collect only the information needed for the review", "Keep evidence context and sources traceable", "Restrict access to private workspace records", "Separate observed facts from analysis and confidence"] }] },
    contact: { eyebrow: "Contact ShadowScore", title: "Talk with an analyst", description: "Request an early access review, discuss a marketplace or payout risk case, or ask about supported platforms, payments, and partnership options.", preferred: "Preferred contact", instructions: "Send a short summary of the marketplace, issue type, and any notice or dashboard screenshot you want reviewed. Do not send marketplace passwords, CVV details, or sensitive card information.", whatsapp: "Open WhatsApp", general: "General", support: "Support" },
    login: { eyebrow: "Secure workspace", title: "Welcome back to ShadowScore.", description: "Sign in to view saved reports, business history, monitoring, account details, and upgrade status.", benefits: ["Recent scans", "Saved reports", "Business history", "Monitoring"], account: "ShadowScore account", signIn: "Sign in", access: "Access your professional risk workspace.", email: "Email", password: "Password", signingIn: "Signing in...", newAccount: "New to ShadowScore?", createAccount: "Create an account", unavailable: "Could not sign in.", authentication: "Authentication is Supabase-ready and falls back to a local development session when provider variables are not configured." },
    signup: { eyebrow: "Create workspace", title: "Create your ShadowScore account", description: "Save reports, track watched entities, and keep your legal acceptance history in one place.", name: "Name", email: "Email", password: "Password", confirmPassword: "Confirm password", agreementStart: "I agree to the", terms: "Terms of Service", agreementJoin: "and", privacy: "Privacy Policy", agreementEnd: "I understand ShadowScore provides analytical risk intelligence only and does not guarantee business outcomes.", creating: "Creating account...", create: "Create account", existing: "Already have an account?", signIn: "Sign in", passwordMismatch: "Passwords do not match.", acceptanceRequired: "You must accept the Terms of Service and Privacy Policy.", unavailable: "Could not create account." },
    example: { eyebrow: "Example executive report", title: "Investigation decision memo", description: "ShadowScore reviewed an evidence package for a marketplace seller seeking continued processing and verification clearance. This example follows observed facts through to a business recommendation.", reportId: "Report ID", subject: "Subject", subjectValue: "Demo marketplace seller", audience: "Audience", audienceValue: "Risk, payments, executive review", status: "Status", statusValue: "Decision support only", recommendation: "Executive recommendation", outcome: "Review required", decision: "Do not grant unrestricted approval yet. Continue limited activity while ownership, supplier authorization, and payment beneficiary evidence are verified.", confidence: "Confidence", confidenceValue: "Moderate", summary: "Investigation summary", verified: "Verified evidence", contradictions: "Contradictions reducing confidence", unknowns: "Remaining unknowns", impact: "Business impact", next: "Recommendation and next steps", appendix: "Evidence appendix" },
  },
  he: {
    security: { eyebrow: "אבטחה וטיפול בנתונים", title: "כיצד ShadowScore מטפלת בנתוני חקירה", description: "ShadowScore משתמשת במידע עסקי מוגבל ובראיות שנמסרו כדי להכין הערכות סיכון מבוססות מקורות.", sections: [{ title: "איסוף נתונים מוגבל", items: ["שמות עסקים, דומיינים ומזהים הנדרשים לבדיקה", "ראיות והקשר שנמסרו לחקירה", "רשומות ציבוריות ואותות תפעוליים גלויים"] }, { title: "רשומות חקירה מוגנות", items: ["הגישה לרשומות פרטיות בסביבת העבודה מוגבלת", "ההקשר והמקורות של הראיות נשמרים לצורך מעקב", "היסטוריית הדוחות והחקירות נשמרת בסביבת העבודה"] }, { title: "פרטי גישה רגישים נשארים בידיכם", items: ["סיסמאות לחשבונות זירות מסחר או תשלום", "מספרי כרטיסים, קודי CVV או פרטי כניסה לבנק", "פרטי גישה למערכות עסקיות של צד שלישי"] }] },
    contact: { eyebrow: "יצירת קשר עם ShadowScore", title: "שיחה עם אנליסט", description: "בקשו סקירת גישה מוקדמת, דונו במקרה סיכון של זירת מסחר או תשלומים, או שאלו על פלטפורמות, תשלומים ואפשרויות שותפות נתמכים.", preferred: "יצירת קשר מועדפת", instructions: "שלחו תקציר קצר של זירת המסחר, סוג הבעיה וכל הודעה או צילום מסך של לוח בקרה שתרצו שנבדוק. אין לשלוח סיסמאות לזירות מסחר, פרטי CVV או פרטי כרטיס רגישים.", whatsapp: "פתיחת WhatsApp", general: "כללי", support: "תמיכה" },
    login: { eyebrow: "סביבת עבודה מאובטחת", title: "ברוכים השבים ל-ShadowScore.", description: "התחברו כדי להציג דוחות שמורים, היסטוריית עסק, ניטור, פרטי חשבון וסטטוס שדרוג.", benefits: ["סריקות אחרונות", "דוחות שמורים", "היסטוריית עסק", "ניטור"], account: "חשבון ShadowScore", signIn: "כניסה", access: "גישה לסביבת העבודה המקצועית שלכם לסיכונים.", email: "דוא״ל", password: "סיסמה", signingIn: "מתבצעת כניסה...", newAccount: "חדשים ב-ShadowScore?", createAccount: "יצירת חשבון", unavailable: "לא ניתן היה להתחבר.", authentication: "האימות מוכן ל-Supabase ומשתמש בהפעלת פיתוח מקומית כאשר משתני הספק אינם מוגדרים." },
    signup: { eyebrow: "יצירת סביבת עבודה", title: "יצירת חשבון ShadowScore", description: "שמרו דוחות, עקבו אחר ישויות שנצפות ושמרו את היסטוריית הקבלה המשפטית במקום אחד.", name: "שם", email: "דוא״ל", password: "סיסמה", confirmPassword: "אימות סיסמה", agreementStart: "אני מסכים/ה ל", terms: "תנאי השירות", agreementJoin: "ול", privacy: "מדיניות הפרטיות", agreementEnd: "ידוע לי ש-ShadowScore מספקת מודיעין סיכונים אנליטי בלבד ואינה מבטיחה תוצאות עסקיות.", creating: "החשבון נוצר...", create: "יצירת חשבון", existing: "כבר יש לכם חשבון?", signIn: "כניסה", passwordMismatch: "הסיסמאות אינן תואמות.", acceptanceRequired: "יש לאשר את תנאי השירות ומדיניות הפרטיות.", unavailable: "לא ניתן היה ליצור חשבון." },
    example: { eyebrow: "דוח ניהולי לדוגמה", title: "מזכר החלטה לחקירה", description: "ShadowScore בחנה חבילת ראיות עבור מוכר בזירת מסחר המבקש המשך עיבוד ואישור אימות. דוגמה זו עוברת מעובדות שנצפו להמלצה עסקית.", reportId: "מזהה דוח", subject: "נושא", subjectValue: "מוכר לדוגמה בזירת מסחר", audience: "קהל יעד", audienceValue: "סיכונים, תשלומים, סקירה ניהולית", status: "סטטוס", statusValue: "תמיכה בהחלטה בלבד", recommendation: "המלצה ניהולית", outcome: "נדרשת סקירה", decision: "אין לאשר אישור בלתי מוגבל בשלב זה. יש להמשיך בפעילות מוגבלת עד לאימות ראיות לבעלות, אישור ספק ומוטב התשלום.", confidence: "רמת ודאות", confidenceValue: "בינונית", summary: "סיכום החקירה", verified: "ראיות מאומתות", contradictions: "סתירות המפחיתות ודאות", unknowns: "נושאים שנותרו לא ידועים", impact: "השפעה עסקית", next: "המלצה והצעדים הבאים", appendix: "נספח ראיות" },
  },
} as const;

export function getUserPageCopy(locale: Locale) {
  return userPageCopy[locale === "he" ? "he" : "en"];
}

/** Product UI copy that is shared by authenticated workspaces. Keep presentation
 * strings here so a locale switch never falls back to component-owned English. */
export const applicationCopy = {
  en: {
    workspace: { eyebrow: "Investigation workspace", title: "Run each case from intake to decision.", description: "Create a case, collect supporting evidence, then prepare it for an analyst decision.", intake: "Case intake", start: "Start an investigation", target: "Target", targetPlaceholder: "Business name or domain", create: "Create preview", active: "Active investigations", open: "Open details", evidence: "Evidence", sourcesAttached: "{count} sources attached", sourcesPending: "Evidence sources will appear when collection begins.", ready: "Ready for analyst decision", verification: "Verification confidence: {score}%.", complete: "Evidence collection is complete and ready for analyst review." },
    monitoring: { eyebrow: "Monitoring", title: "Watchlist monitoring", description: "Review every saved business, marketplace, payment provider, website and supplier from your workspace.", manage: "Manage watchlist", watched: "Watched", needsEvidence: "Needs evidence", highRisk: "High risk", loading: "Loading monitored businesses...", unavailable: "Monitoring unavailable", loadError: "We could not load your watchlist. Check your connection and try again.", empty: "No monitored businesses yet", emptyCopy: "Use the dashboard watchlist form to add your first business.", riskLevel: "Risk level:" },
    account: { loading: "Loading account...", eyebrow: "Account settings", userId: "User ID", created: "Created", lastLogin: "Last login", openDashboard: "Open dashboard", signOut: "Sign out", unavailable: "Not available", notice: "Password reset, two-factor authentication, and login history are planned for a future secure backend release." },
  },
  he: { workspace: { eyebrow: "סביבת עבודה לחקירות", title: "נהלו כל תיק מקליטה ועד החלטה.", description: "צרו תיק, אספו ראיות תומכות והכינו אותו להחלטת אנליסט.", intake: "קליטת תיק", start: "התחלת חקירה", target: "יעד", targetPlaceholder: "שם עסק או דומיין", create: "יצירת תצוגה מקדימה", active: "חקירות פעילות", open: "פתיחת פרטים", evidence: "ראיות", sourcesAttached: "{count} מקורות מצורפים", sourcesPending: "מקורות ראיות יופיעו עם תחילת האיסוף.", ready: "מוכן להחלטת אנליסט", verification: "ודאות אימות: {score}%.", complete: "איסוף הראיות הושלם ומוכן לסקירת אנליסט." }, monitoring: { eyebrow: "ניטור", title: "ניטור רשימת מעקב", description: "סקירת כל עסק, זירת מסחר, ספק תשלומים, אתר וספק שנשמרו בסביבת העבודה.", manage: "ניהול רשימת המעקב", watched: "במעקב", needsEvidence: "נדרשות ראיות", highRisk: "סיכון גבוה", loading: "טעינת עסקים במעקב...", unavailable: "הניטור אינו זמין", loadError: "לא ניתן לטעון את רשימת המעקב. בדקו את החיבור ונסו שוב.", empty: "עדיין אין עסקים במעקב", emptyCopy: "השתמשו בטופס רשימת המעקב בלוח הבקרה כדי להוסיף את העסק הראשון.", riskLevel: "רמת סיכון:" }, account: { loading: "טעינת חשבון...", eyebrow: "הגדרות חשבון", userId: "מזהה משתמש", created: "נוצר", lastLogin: "כניסה אחרונה", openDashboard: "פתיחת לוח בקרה", signOut: "התנתקות", unavailable: "לא זמין", notice: "איפוס סיסמה, אימות דו-שלבי והיסטוריית כניסות מתוכננים לגרסת backend מאובטחת בעתיד." } },
  ar: { workspace: { eyebrow: "مساحة عمل التحقيق", title: "أدر كل حالة من الإدخال إلى القرار.", description: "أنشئ حالة واجمع الأدلة الداعمة ثم أعدها لقرار المحلل.", intake: "إدخال الحالة", start: "بدء تحقيق", target: "الهدف", targetPlaceholder: "اسم النشاط أو النطاق", create: "إنشاء معاينة", active: "التحقيقات النشطة", open: "فتح التفاصيل", evidence: "الأدلة", sourcesAttached: "تم إرفاق {count} مصادر", sourcesPending: "ستظهر مصادر الأدلة عند بدء الجمع.", ready: "جاهز لقرار المحلل", verification: "ثقة التحقق: {score}%.", complete: "اكتمل جمع الأدلة وهو جاهز لمراجعة المحلل." }, monitoring: { eyebrow: "المراقبة", title: "مراقبة قائمة المتابعة", description: "راجع كل نشاط تجاري وسوق ومزود دفع وموقع ومورد محفوظ في مساحة العمل.", manage: "إدارة قائمة المتابعة", watched: "تحت المراقبة", needsEvidence: "يحتاج إلى أدلة", highRisk: "خطر مرتفع", loading: "جار تحميل الأنشطة المراقبة...", unavailable: "المراقبة غير متاحة", loadError: "تعذر تحميل قائمة المتابعة. تحقق من الاتصال وحاول مرة أخرى.", empty: "لا توجد أنشطة مراقبة بعد", emptyCopy: "استخدم نموذج قائمة المتابعة في لوحة التحكم لإضافة نشاطك الأول.", riskLevel: "مستوى الخطر:" }, account: { loading: "جار تحميل الحساب...", eyebrow: "إعدادات الحساب", userId: "معرف المستخدم", created: "تاريخ الإنشاء", lastLogin: "آخر تسجيل دخول", openDashboard: "فتح لوحة التحكم", signOut: "تسجيل الخروج", unavailable: "غير متاح", notice: "تخطط المنصة لإضافة إعادة تعيين كلمة المرور والمصادقة الثنائية وسجل الدخول في إصدار خلفي آمن مستقبلاً." } },
  es: { workspace: { eyebrow: "Espacio de investigación", title: "Gestione cada caso desde la entrada hasta la decisión.", description: "Cree un caso, recopile evidencia de apoyo y prepárelo para una decisión de analista.", intake: "Entrada del caso", start: "Iniciar una investigación", target: "Objetivo", targetPlaceholder: "Nombre comercial o dominio", create: "Crear vista previa", active: "Investigaciones activas", open: "Abrir detalles", evidence: "Evidencia", sourcesAttached: "{count} fuentes adjuntas", sourcesPending: "Las fuentes de evidencia aparecerán cuando comience la recopilación.", ready: "Listo para la decisión del analista", verification: "Confianza de verificación: {score}%.", complete: "La recopilación de evidencia está completa y lista para la revisión del analista." }, monitoring: { eyebrow: "Monitoreo", title: "Monitoreo de lista de seguimiento", description: "Revise cada empresa, marketplace, proveedor de pagos, sitio web y proveedor guardado en su espacio de trabajo.", manage: "Gestionar lista de seguimiento", watched: "En seguimiento", needsEvidence: "Necesita evidencia", highRisk: "Alto riesgo", loading: "Cargando negocios monitoreados...", unavailable: "Monitoreo no disponible", loadError: "No se pudo cargar su lista de seguimiento. Revise la conexión e inténtelo de nuevo.", empty: "Aún no hay negocios monitoreados", emptyCopy: "Use el formulario de lista de seguimiento del panel para añadir su primer negocio.", riskLevel: "Nivel de riesgo:" }, account: { loading: "Cargando cuenta...", eyebrow: "Configuración de cuenta", userId: "ID de usuario", created: "Creado", lastLogin: "Último acceso", openDashboard: "Abrir panel", signOut: "Cerrar sesión", unavailable: "No disponible", notice: "El restablecimiento de contraseña, la autenticación de dos factores y el historial de acceso están previstos para una futura versión segura del backend." } },
  fr: { workspace: { eyebrow: "Espace d’enquête", title: "Gérez chaque dossier de la saisie à la décision.", description: "Créez un dossier, recueillez les éléments justificatifs, puis préparez-le pour une décision d’analyste.", intake: "Saisie du dossier", start: "Démarrer une enquête", target: "Cible", targetPlaceholder: "Nom de l’entreprise ou domaine", create: "Créer un aperçu", active: "Enquêtes actives", open: "Ouvrir les détails", evidence: "Éléments", sourcesAttached: "{count} sources jointes", sourcesPending: "Les sources apparaîtront lorsque la collecte commencera.", ready: "Prêt pour la décision de l’analyste", verification: "Confiance de vérification : {score} %.", complete: "La collecte est terminée et prête pour l’examen de l’analyste." }, monitoring: { eyebrow: "Surveillance", title: "Surveillance de la liste de suivi", description: "Examinez chaque entreprise, place de marché, prestataire de paiement, site et fournisseur enregistré dans votre espace de travail.", manage: "Gérer la liste de suivi", watched: "Surveillés", needsEvidence: "Éléments requis", highRisk: "Risque élevé", loading: "Chargement des entreprises surveillées...", unavailable: "Surveillance indisponible", loadError: "Votre liste de suivi n’a pas pu être chargée. Vérifiez votre connexion et réessayez.", empty: "Aucune entreprise surveillée", emptyCopy: "Utilisez le formulaire de suivi du tableau de bord pour ajouter votre première entreprise.", riskLevel: "Niveau de risque :" }, account: { loading: "Chargement du compte...", eyebrow: "Paramètres du compte", userId: "ID utilisateur", created: "Créé", lastLogin: "Dernière connexion", openDashboard: "Ouvrir le tableau de bord", signOut: "Se déconnecter", unavailable: "Indisponible", notice: "La réinitialisation du mot de passe, l’authentification à deux facteurs et l’historique des connexions sont prévus dans une prochaine version sécurisée du backend." } },
  de: { workspace: { eyebrow: "Untersuchungsarbeitsbereich", title: "Bearbeiten Sie jeden Fall von der Aufnahme bis zur Entscheidung.", description: "Erstellen Sie einen Fall, sammeln Sie Belege und bereiten Sie ihn für eine Analystenentscheidung vor.", intake: "Fallaufnahme", start: "Untersuchung starten", target: "Ziel", targetPlaceholder: "Unternehmensname oder Domain", create: "Vorschau erstellen", active: "Aktive Untersuchungen", open: "Details öffnen", evidence: "Belege", sourcesAttached: "{count} Quellen angehängt", sourcesPending: "Belegquellen erscheinen, sobald die Erfassung beginnt.", ready: "Bereit für die Analystenentscheidung", verification: "Verifizierungsvertrauen: {score} %.", complete: "Die Belegerfassung ist abgeschlossen und für die Analystenprüfung bereit." }, monitoring: { eyebrow: "Überwachung", title: "Überwachung der Beobachtungsliste", description: "Prüfen Sie jedes gespeicherte Unternehmen, jeden Marktplatz, Zahlungsanbieter, jede Website und jeden Lieferanten in Ihrem Arbeitsbereich.", manage: "Beobachtungsliste verwalten", watched: "Beobachtet", needsEvidence: "Belege erforderlich", highRisk: "Hohes Risiko", loading: "Überwachte Unternehmen werden geladen...", unavailable: "Überwachung nicht verfügbar", loadError: "Ihre Beobachtungsliste konnte nicht geladen werden. Prüfen Sie die Verbindung und versuchen Sie es erneut.", empty: "Noch keine überwachten Unternehmen", emptyCopy: "Verwenden Sie das Beobachtungslistenformular im Dashboard, um Ihr erstes Unternehmen hinzuzufügen.", riskLevel: "Risikostufe:" }, account: { loading: "Konto wird geladen...", eyebrow: "Kontoeinstellungen", userId: "Benutzer-ID", created: "Erstellt", lastLogin: "Letzte Anmeldung", openDashboard: "Dashboard öffnen", signOut: "Abmelden", unavailable: "Nicht verfügbar", notice: "Passwortzurücksetzung, Zwei-Faktor-Authentifizierung und Anmeldeverlauf sind für eine zukünftige sichere Backend-Version geplant." } },
} as const satisfies Record<Locale, Record<string, unknown>>;

export function getApplicationCopy(locale: Locale) {
  return applicationCopy[locale];
}

export function interpolate(copy: string, values: Record<string, string | number>) {
