export type InvestigationStatus = "PASS" | "PROCEED_WITH_VERIFICATION" | "REVIEW" | "STOP";
...
export function buildCanonicalDecision(input: {
  ...
  if (input.hasMaterialContradiction || input.status === "REVIEW") {
