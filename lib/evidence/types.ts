import type { ProviderCategory, ProviderEvidence, ProviderFinding, ProviderResult, RegulatoryEvidenceClassification } from "../providers/types";
...
export type EvidenceItem = { id: string; source: string; provider: string; category: EvidenceCategory; status: EvidenceStatus; confidence: number; title: string; description: string; businessImpact: string; evidenceRefs: EvidenceRef[]; regulatoryClassification?: RegulatoryEvidenceClassification; authoritative?: boolean };
