...
export const PROVIDER_CAPABILITY_REGISTRY: ProviderCapabilityRegistration[] = [
  ...
  { id: "official-company-registry", capability: "registry", targetTypes: ["company", "legal_entity", "registration_number"], credentialEnv: "COMPANY_REGISTRY_API_KEY", legalBasis: "open_data" },
