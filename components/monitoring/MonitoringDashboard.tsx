...
export function MonitoringDashboard({entities,snapshots,alerts}:{entities:MonitoredEntity[];snapshots:MonitoringSnapshot[];alerts:MonitoringAlert[]}) {
  ...
  return <div className="monitoring-page">
    <header className="monitoring-heading"><div><p className="workspace-eyebrow">Continuous intelligence</p><h1>Monitoring</h1><p>Track material changes across companies, providers, and trust scores.</p></div><button type="button">Add monitor</button></header>
