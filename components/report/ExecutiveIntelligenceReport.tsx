  ...
  return <>
    <section aria-labelledby="report-workspace-title" className="mb-6 grid gap-5 border-b border-white/10 pb-6 print:hidden lg:grid-cols-[1fr_auto] lg:items-end">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">Investigation {report.intakeId || report.reportId}. Version 1.0. Only members of the purchasing account can open this report.</p>
      </div>
