...
export default function Home() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "Operational marketplace exposure indicators, seller stability signals and enforcement-adjacent behavioral patterns.",
    },
    {
...
I would like a private marketplace exposure audit.`;
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <header className="sticky top-0 z-50 border-b border-red-950/30 bg-black/80 backdrop-blur-xl">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="mt-8 text-xl text-zinc-400 leading-relaxed max-w-2xl">
              ShadowScore is a cyber-intelligence agent for marketplace sellers.
              It detects silent trust decay, tracking anomalies, payout
              instability and enforcement exposure before MC### reviews, payout
              holds or account restrictions happen.
            </p>

            <p className="mt-5 text-zinc-500 text-lg max-w-2xl">
              Tracking delays, velocity spikes, TBA exposure and buyer signals
              create invisible marketplace risk long before visible warnings
              appear.
            </p>
            ...
            <div className="flex gap-10 mt-10">
              <div>
                <div className="text-5xl font-black text-red-500">30 Days</div>
                <div className="text-zinc-400 mt-2">Risk Protection</div>
              </div>

              <div>
                <div className="text-5xl font-black text-red-500">$199</div>
                <div className="text-zinc-400 mt-2">First Audit</div>
              </div>

              <div>
                <div className="text-5xl font-black text-red-500">No Login</div>
                <div className="text-zinc-400 mt-2">Password Needed</div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="rounded-[36px] border border-white/10 bg-black/60 backdrop-blur-xl p-10">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 mt-10">
            {[
              ["2,186", "Stores Reviewed", "+35 today", "+315 this month"],
              ["420", "Risk Events", "+10 today", "+75 this month"],
              ["269", "Alerts Sent", "+7 today", "+52 this month"],
              ["92", "Sellers Stabilized", "+4 today", "+24 this month"],
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
          {[
            [
              "01",
              "Observe",
              "Reads tracking quality, seller velocity, claims, refunds and buyer signals.",
            ],
            [
              "02",
              "Score",
              "Creates a hidden trust profile and detects marketplace exposure.",
            ],
            [
              "03",
              "Warn",
              "Alerts before risk becomes enforcement, payout hold or seller review.",
            ],
            [
              "04",
              "Prepare",
              "Tells sellers which data to strengthen before the account is exposed.",
            ],
          ].map(([num, title, text]) => (
            <div
              key={title}
        ...
        <div className="fixed inset-0 z-[999] bg-black/90 backdrop-blur-xl flex items-center justify-center px-6">
          <div className="w-full max-w-2xl rounded-[32px] border border-red-500/20 bg-black p-10">
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-black/60 p-5">
              ...
              <div className="mt-3 text-xl">{scanText}</div>
            </div>

            <div className="space-y-4 mt-8 text-zinc-400">
              <div>● Reading marketplace signals</div>
              <div>● Checking tracking exposure</div>
              <div>● Analyzing behavioral drift</div>
              <div>● Comparing enforcement similarity</div>
