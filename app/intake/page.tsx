        ...
        <div className="grid gap-10 lg:grid-cols-[.95fr_1.05fr]">
          <div>
            ...
            <div className="mt-6 rounded-3xl border border-red-400/20 bg-red-500/[0.06] p-6">
              <div className="font-bold text-red-200">Security note</div>
              <p className="mt-3 leading-7 text-zinc-400">
                No marketplace password is required for the first review. Submit only evidence and operational context.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-[32px] border border-white/10 bg-black/55 p-6 shadow-[0_0_60px_rgba(120,0,20,0.16)] backdrop-blur-xl">
            ...
            <div className="mt-6 flex items-center justify-between rounded-2xl border border-white/10 p-5">
              <div>
                <div className="text-xs uppercase tracking-[0.28em] text-zinc-500">Intake status</div>
            ...
            <a href="/analysis" className="mt-6 inline-block rounded-2xl bg-red-600 px-7 py-4 text-sm font-bold hover:bg-red-500">
