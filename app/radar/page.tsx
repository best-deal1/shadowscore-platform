    ...
    <main className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <header className="relative z-10 border-b border-white/10 bg-black/85 px-6 py-5 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl justify-between">
          ...
          <a href="/intake" className="text-sm font-bold text-red-300 hover:text-red-200">Start Audit</a>
        </div>
      </header>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-14">
        ...
        <h1 className="mt-6 text-5xl font-extrabold">The Score Sellers Never See</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-zinc-400">
          ShadowScore gives visibility into the operational signals that may increase marketplace enforcement exposure.
        </p>
