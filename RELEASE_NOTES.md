...
- Investigation Workspace users can select visible results, delete them in one confirmed action, and retry only the investigations that could not be deleted.
