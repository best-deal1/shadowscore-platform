...
- Personal identity investigations now preserve contradictory contact evidence, use source-level corroboration, show identity-specific report and checkout language, and remain gated until the required private Supabase storage is verified.
