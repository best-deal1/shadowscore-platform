...
- Evidence-bearing derivatives of a submitted identifier now receive a bounded continuation before speculative social handles. Discovery can follow public pages and neighboring identifiers without changing resolver attribution or the search limit.
